// Vendored verbatim from archify renderers/shared/i18n.mjs (MIT, author tt-a1i).
// hydraulify authors in English only; this module is kept unchanged so the
// vendored viewer template's {{i18n:...}} placeholders resolve exactly as
// they do upstream, and so a future re-vendor is a straight file copy.
